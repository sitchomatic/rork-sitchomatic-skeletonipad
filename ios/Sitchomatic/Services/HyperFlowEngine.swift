...
public final class WebViewPool {
    ...
    public var diagnosticSummary: String {
        let recyclerPool = WebViewRecycler.shared.poolSize
        let poolMode = WebViewProcessPoolManager.shared.diagnosticSummary
        return "Active: \(activeViews.count) | Recycler: \(recyclerPool) | \(poolMode)"
    }
}
